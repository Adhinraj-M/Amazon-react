...
function HomeProductData() {
  ...
  const [productData,setProductData] = useState<Products[] | undefined>(filterList)
      ...
      <Sponsored/>
   {
    productData && (
       <div className="bg-white min-w-50 p-[0_14px] m-[0_auto] w-full">
        ...
        { 
          ( productData[0]?.product_category === 'women_kurtis' || productData[0]?.product_category === 'men_clothing' ) &&  (<div className="p-[16px_14px_16px] relative border-t-[5px] border-t-[#F3F3F3] border-b border-b-[#d5d9d9] m-[0_-14px_12px] overflow-hidden bg-transparent">
            <div className="mb-4">
              <span className=" text-[15px] leading-[1.35] p-0 ">
                Colour: <span className="uppercase font-fontBold">black</span>
              </span>
            </div>
                ...
                <li className="m-[0_0_0_5px]  inline-block w-20 pb-3 text-[15px] ">
                  ...
                  <div className="mt-[11px] text-[11px] relative ">
                    ...
                    <div className="text-center flex flex-col gap-y-0.5 relative top-2">
                      <span className="mr-0.5 ml-0.5 block"> ₹{productData[0]?.product_price}</span>
        ...
        <div className="flex items-center">
          ...
          <span className="mr-1 text-[38px] ">
            ...
            <span>            {productData[0]?.product_price}
</span>
          </span>
        </div>
        <span className="text-[#565959] mb-2 text-[13px]">
          M.R.P.: <span className="inline-block  line-through">₹{productData[0]?.product_actual_price}</span>{" "}
        </span>
        ...
        <div className="mt-0.5 bg-white p-[12px_0px]">
          ...
          { ProvidingBenefits && ProvidingBenefits.map((item,index)=>{
            return(
                <div className="inline-flex mb-[13px] gap-x-[7px]" key={index}>
                 <img className="h-5 w-5 mt-0.5 min-w-5 min-h-5 align-top" src={item.img.src} alt={item.img.alt} />
                 <span className="inline-flex mr-0 text-[#2162a1] text-[15px] leading-5 text-left tracking-normal ">{item.benefits}</span>
                </div>
            )
           }) 
          }
