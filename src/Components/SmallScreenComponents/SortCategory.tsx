...
const {handleCateShow,cateList,selectCateCount,handleClearFilter} = useContext(HomeProductContext)
  ...
  return (
    <div className="sticky top-12 bg-[transparent] shadow-[0_1px_2px_0_hsla(0,0%,7%,.15)] -ml-2 -mr-2 z-[208] !mb-2  ">
        <div className="mb-0 bg-white flex ml-2 mr-0 overflow-x-auto pb-2 pt-2 scroll-width-none">
            { selectCateCount>0  &&<div className={`mr-2 border rounded-[7px] p-[4px_8px] text-center whitespace-nowrap w-auto  bg-white  border-[#e8e8e8]`}>
