...
function FilterHome() {
  ...
  return (
    <div className=" translate-y-0 h-85 fixed top-auto bottom-0 right-0 left-0 z-[500]">
      <div className="opacity-75 bg-black select-none fixed top-0 right-0 bottom-0 left-0 z-[499]"></div>
        <div className="h-75 max-h-[737px] bg-white absolute right-0 bottom-0 left-0 z-[501]">
            <button className="m-[-14px_-14px_0_0] p-3.5 absolute right-5 -top-9 text-white bg-transparent leading-4 min-w-11 float-right min-h-11 cursor-pointer border-none">
            ...
            <div className="overflow-y-auto h-full bg-white overflow-x-hidden ">
                ...
                <div className="mb-0 bg-white border-t border-b border-[#cbcbcb] fixed bottom-0 h-16 m-0 p-2.5 w-full">
                    ...
                    <button className="rounded-lg mb-0 inline-block h-10.5 overflow-hidden p-2.5 bg-[#007185] text-white max-w-[45%] absolute right-2.5 text-[15px] leading-[1.35] ">Apply Filters</button>
                </div>
            </div>
        </div>
    </div>
