    ...
    <header>
      ...
      {/* first section  */}
        <div className="h-[60px] flex">
          <div className="m-[1px_1px_1px_2px] w-auto p-[5px_8px_0px_6px] flex relative top-0 right-0 bottom-0 left-0 flex-shrink-0 cursor-pointer lap2xl:m-[1px_1px_1px_12px] desk2xl:m-[1px_1px_1px_16px] ">
            <span
          ...
          <div className="w-auto h-[60px] p-0 m-0 flex overflow-hidden static lap2xl:ml-0.5 desk2xl:ml-1.5 ">
        ...
        <div className="h-[60px] flex mt-0.5 p-[3px_0px_0px_0px] ">
          ...
          <div className="m-[0_1px] p-[0px_6px_5px_7px] flex relative ">
            <a
              href="#"
              className="p-[0_0_5px] m-[1px] items-center text-white text-sm leading-11  flex static h-[50px]"
            >
          ...
          <div className="mr-0 ml-0 px-[9px] flex relative items-start left-0 right-0 bottom-0 top-0 lap2xl:ml-0.5 desk2xl:ml-1.5">
            <a
              href="#"
              className="p-[0_4px_8px] flex flex-shrink-0 justify-center pl-[9px] h-[50px] overflow-hidden flex-col flex-nowrap m-[0px_1px]"
            >
          ...
          <div className="h-[50px] mr-0 ml-0 p-[0px_9px_10px_9px] flex flex-col flex-nowrap justify-center static lap2xl:ml-0.5 desk2xl:ml-1.5">
            ...
            {/* cart section  */}
          <a
            className="flex p-[0_9px_11px] justify-center ml-0 mr-[1px] flex-row flex-nowrap h-[50px] lap2xl:m-[0px_11px_0px_2px] desk2xl:m-[0px_15px_0px_6px] "
            href="#"
          >
