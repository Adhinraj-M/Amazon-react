            ...
            return (
              <div key={index} className="">
                {index === 6 ? (
                  ...
                  >
                    <a
                      className="m-[5px_0px_6px_0px] p-[8px-5px] h-7 text-white text-sm flex items-center "
                      href="#"
                    >
                      {item}
                    </a>
                    <button
                      className={`m-[18px_0px_4px] relative left-[5px] border-4 border-b-0 cursor-pointer border-[transparent] inline-block border-t-[#a7acb2] p-0  w-0 h-0 leading-0 items-center `}
                    ></button>
                    {index === 6 && openModal === true && <PrimeModal />}
                  </li>
                ) : (
                  <li
                    className="inline-flex p-[0px_10px] relative align-middle h-full hover:outline hover:outline-white "
