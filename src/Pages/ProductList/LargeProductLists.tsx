    ...
    <div className="min-large:block hidden">
                    ...
                    <li
                      ...
                      className={` ${
                        index === 0
                          ? "m-[6px_13px_0_7px]"
                          : "m-[6px_13px_0_3px]"
                      }   inline-block  w-18.5 align-top text-left min-h-full`}
                    >
                      <div
      ...
      <div className="mb-3 mt-3 w-full flex">
        <div className="mx-auto p-0 bg-white overflow-auto  w-[90%] max-w-[1500px] min-w-250">
          <h1 className="text-lg leading-6 font-fontBold text-[#0f1111]">
            Previously viewed
          </h1>
          <div className="flex mt-2 mb-[22px] overflow-auto scroll-width-none">
            <div className="mr-[85px] items-start flex text-center  ml-5">
              <div className="aspect-[18/19] flex justify-center relative items-center bg-[#fafafa] mr-[5px]">
                <img
                  src={cateProduct[5]?.product_img[0]}
                  alt={cateProduct[5]?.product_title}
                  className="flex-[0_0_auto] m-auto h-[288.88px] mix-blend-multiply w-[219.8px]"
                />
              </div>
              <div className="w-62.5 ml-5 text-left text-[0f1111]">
                <h1 className="leading-[20.8px] line-clamp-2 m-[8px_0_0_0] text-[16px]">
                  {cateProduct[5]?.product_title}
                </h1>
                ...
                <div className="flex">
                  ...
                  <span className="text-[28px] text-[#0f1111] ">
                    ...
                    <span className="font-medium">
                      {cateProduct[5]?.product_price}
                    </span>
                    <span className="text-[13px] top-[-9.75px] relative">
                      00
                    </span>
                  </span>
                  <span className="inline-block text-[#565959] ml-1 text-xs relative left-0 top-5 z-[1] line-through">
                    ₹{cateProduct[5]?.product_actual_price}{" "}
                  </span>
                </div>
                <div className="flex items-center pt-1 flex-wrap text-sm">
                  <span className="flex">
                    Get it by &nbsp;<b>Wednesday, August 27</b>
                  </span>
                  <span className="leading-5">FREE Delivery by Amazon</span>
                </div>

                <button className="mt-3 flex items-center justify-center h-7.5 rounded-[100px] w-50 bg-[#ffd814] border border-[#ffd814] text-center align-middle cursor-pointer text-black text-[13px]">
                  Add to Cart
                </button>
              </div>
            </div>
            ...
            <div className="mr-[85px] items-start flex text-center  ml-5">
              <div className="aspect-[18/19] flex justify-center relative items-center bg-[#fafafa] mr-[5px]">
                <img
                  src={cateProduct[8]?.product_img[0]}
                  alt={cateProduct[8]?.product_title}
                  className="flex-[0_0_auto] m-auto h-[288.88px] mix-blend-multiply w-[219.8px]"
                />
              </div>
              <div className="w-62.5 ml-5 text-left text-[0f1111]">
                <h1 className="leading-[20.8px] line-clamp-2 m-[8px_0_0_0] text-[16px]">
                  {cateProduct[8]?.product_title}
                </h1>
                <div className="flex items-center">
                  <i
                    className="bg-[position:-2px_-400px] bg-[length:512px_512px] bg-no-repeat mr-1 -top-px h-4.5 w-20 relative align-text-top inline-block"
                ...
                <div className="flex">
                  ...
                  <span className="inline-block text-[#565959] ml-1 text-xs relative left-0 top-5 z-[1] line-through">
                    ₹{cateProduct[8]?.product_actual_price}{" "}
                  </span>
                </div>
                <div className="flex items-center pt-1 flex-wrap text-sm">
                  <span className="flex">
        ...
        <div className=" w-[90%] max-w-[1500px] min-w-250 mx-auto">
          <ol className="overflow-hidden flex-wrap max-h-25 flex pt-3.5 grow m-0 bg-transparent list-none ">
            {filterCategory.length > 0 &&
              filterCategory.map((item, i: any) => {
                const arrSelected = Object.keys(selectedFilters);
                item.filter_Type =
                  item.filter_buttons.length === 0
                    ? "Customer Rating"
                    : item.filter_Type;
                return (
                  <li key={i} className="inline-block mr-[5px] mb-3 m-0">
                    <button
                      onClick={() => handleFilterModal(i)}
                      className={`${
                        arrSelected.includes(item.filter_Type) ||
                        item.filter_Type === "Price and Deals"
                          ? "border-2 border-[#007185] bg-[#e7fbff]"
                          : ""
                      } flex items-center border  cursor-pointer  h-8 min-w-14 max-w-47.5 rounded-lg hover:border-[#007185] hover:bg-[#e7fbff]`}
                    >
                      <span className="flex items-center pl-3 text-[#0f1111] whitespace-nowrap max-w-40 text-sm leading-[18.2px]">
                        {item.filter_Type}
                      </span>
                      <svg
                        className="m-[0_12px_0_4px]"
                        role="img"
                        aria-label="open price modal"
                        width="12"
                        height="12"
                        viewBox="0 0 12 12"
                        fill="none"
                      ...
                      >
                        <path
                          d="M5.99982 10.0001L2.29361 6.58305C2.1055 6.40915 1.99982 6.17329 1.99982 5.92736C1.99982 5.68142 2.1055 5.44556 2.29361 5.27166C2.48172 5.09776 2.73685 5.00006 3.00288 5.00006C3.26891 5.00006 3.52405 5.09776 3.71216 5.27166L5.99982 7.39575L8.28748 5.27166C8.38062 5.18555 8.4912 5.11725 8.6129 5.07065C8.73459 5.02405 8.86503 5.00006 8.99675 5.00006C9.12848 5.00006 9.25891 5.02405 9.38061 5.07065C9.50231 5.11725 9.61288 5.18555 9.70603 5.27166C9.79917 5.35777 9.87306 5.45999 9.92346 5.5725C9.97387 5.685 9.99982 5.80558 9.99982 5.92736C9.99982 6.04913 9.97387 6.16971 9.92346 6.28222C9.87306 6.39472 9.79917 6.49694 9.70603 6.58305L5.99982 10.0001Z"
                          fill="#0F1111"
                        ></path>
                      </svg>
                    </button>
